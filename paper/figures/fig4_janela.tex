...
\addplot[only marks, mark=*, mark size=2.4pt, draw=cprophet, fill=cprophet] coordinates {(6.8804,1)};
\addplot[only marks, mark=square*, mark size=2.0pt, draw=csarima, fill=csarima] coordinates {(6.8569,1)};
